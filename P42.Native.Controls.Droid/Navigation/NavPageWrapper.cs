...
namespace P42.Native.Controls.Droid
{
    public partial class NavPageWrapper : ViewGroup
    {
        ...
        {
            Color = Color.Black,
            StrokeWidth = P42.Native.Controls.Droid.DisplayExtensions.DipToPx(1),
        ...
        */
        ...
        {
            if (e.PropertyName == nameof(P42.Native.Controls.Droid.Page.Title))
                UpdateTitle();
            else if (e.PropertyName == nameof(P42.Native.Controls.Droid.Page.BackButtonTitle))
                UpdateBackButton();
            else if (e.PropertyName == nameof(P42.Native.Controls.Droid.Page.HasBackButton))
                UpdateBackButton();
        }
